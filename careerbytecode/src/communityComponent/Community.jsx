            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button
                        ...
                        className="px-8 py-4 bg-gradient-to-r from-cyan-400 to-blue-500 text-white rounded-lg font-bold hover:from-cyan-500 hover:to-blue-600 transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        className="px-8 py-4 border-2 border-white/30 text-white rounded-lg font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
